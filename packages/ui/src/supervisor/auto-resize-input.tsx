...
const AutoResizeInput = React.forwardRef<HTMLInputElement, AutoResizeInputProps>(
    ({ className, minWidth = 100, fullWidth = false, value, placeholder, onChange, ...props }, ref) => {
        ...
        }, [value, placeholder, minWidth, fullWidth])

        return (
            <div className={cn("relative inline-flex min-w-0 max-w-full", fullWidth && "w-full")}>
