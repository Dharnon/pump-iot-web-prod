...
export default function PdfExtractorPage() {
  ...
  return (
    <div className="h-full flex flex-col gap-6 p-6 overflow-auto">
      ...
      <div
        className={`grid gap-6 flex-1 min-h-0 ${pdfFile ? "lg:grid-cols-2" : ""}`}
      >
              ...
              <div className="flex-1 flex items-center justify-center p-6 bg-muted/10 h-[500px]">
                <Empty className="border-2 border-dashed rounded-lg bg-background p-10">
                  <EmptyHeader>
                    ...
                    <EmptyDescription>
                      Selecciona un reporte en formato PDF para visualizarlo y
                      extraer sus datos automáticamente.
                    </EmptyDescription>
                  </EmptyHeader>
                  <EmptyContent>
          ...
          <div className="flex flex-col gap-6 min-h-0">
            ...
            <Card className="flex-1 flex flex-col min-h-0 overflow-hidden">
              <CardHeader className="shrink-0">
                ...
                <CardDescription>
                  Texto estructurado obtenido del PDF
                </CardDescription>
              </CardHeader>
