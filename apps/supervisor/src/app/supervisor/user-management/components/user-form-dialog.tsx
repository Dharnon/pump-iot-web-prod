...
const userSchema = z.object({
    ...
    role: z.enum(["supervisor", "operario"] as [string, ...string[]]),
    isActive: z.boolean().default(true),
    password: z.string().optional(), // Optional for edit, required logic handled in submit
});
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {user ? "Modifique los datos del usuario aquí." : "Ingrese los datos para el nuevo usuario."}
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>{user ? "Contraseña (Opcional)" : "Contraseña"}</FormLabel>
                                    <FormControl>
