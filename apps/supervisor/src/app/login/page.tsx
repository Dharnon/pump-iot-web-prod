...
// =============================================================================
// COMPONENTE INTERNO (Lógica con SearchParams)
// =============================================================================
...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (errorParam === "session_expired") {
      ...
      setError(
        "Error de validación de sesión. Por favor, inicia sesión nuevamente.",
      );
    }
  }, [searchParams]);
 ...
 * Página de Login
 *
 * Renderiza el formulario dentro de un Suspense boundary para soportar useSearchParams
 */
export default function LoginPage() {
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative">
      ...
      <Suspense
        fallback={
          <div className="w-full max-w-md mx-4 p-8 text-center">
            Cargando...
          </div>
        }
      >
