    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <CleanInput 
          ...
          unit="m" 
          onChange={(val) => onDataChange("detallesCorreccionManometrica", val)} 
        ...
        <CleanInput 
          ...
          unit="mbar" 
          onChange={(val) => onDataChange("detallesPresionAtmosferica", val)} 
          className="h-8 text-xs" 
        />
        <CleanInput 
          label="Temp. Agua" 
        ...
        <CleanInput 
          ...
          unit="°C" 
          onChange={(val) => onDataChange("detallesTemperaturaAmbiente", val)} 
          className="h-8 text-xs" 
        />
        <CleanInput 
          ...
          unit="°C" 
          onChange={(val) => onDataChange("detallesTemperaturaLadoAcoplamiento", val)} 
          className="h-8 text-xs" 
        />
        <CleanInput 
          ...
          unit="°C" 
          onChange={(val) => onDataChange("detallesTemperaturaLadoBomba", val)} 
          className="h-8 text-xs" 
        />
        <CleanInput 
          label="Tiempo Func." 
          ...
          unit="min" 
          onChange={(val) => onDataChange("detallesTiempoFuncionamientoBomba", val)} 
          className="h-8 text-xs" 
        />
      </div>
